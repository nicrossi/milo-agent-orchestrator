...
-- Index for the activity-scoped retrieval branch in src/services/rag.py.
-- See TODO in rag.py:51 — existing rows are activity_id = NULL until a
-- re-ingest backfill tags each row with its source activity.
