...
#### Levels
- **Descriptive**: the response is vague, purely descriptive, or does not show real reflection
- **Basic**: the response shows partial reflection, but it is still superficial or incomplete
- **Deep**: the response clearly explains understanding, difficulty, or meaning in a coherent way
- **Exceptional**: the response critically evaluates underlying assumptions

#### Teacher interpretation
- **Descriptive**: the student may need more scaffolding to verbalize learning
- **Basic**: the student shows partial evidence but may still need guided reflection
- **Deep**: the student shows solid reflective evidence for that interaction
- **Exceptional**: the student exhibits strong metacognitive skills
...
#### Levels
- **Misaligned**: strong misalignment between perceived understanding and demonstrated understanding
- **Partial**: partial or moderate alignment
- **Aligned**: good alignment between self-perception and demonstrated understanding

#### Teacher interpretation
- **Misaligned**: the student may be overconfident or underconfident and may need guided self-evaluation
- **Partial**: the student shows some alignment, but not consistently
- **Aligned**: the student seems able to position themselves reasonably well relative to their own understanding
...
#### Levels
- **Lacking**: the student cannot connect the topic to a meaningful context
- **Vague**: the student mentions a context, but the connection is vague, weak, or forced
- **Meaningful**: the student connects the concept to a clear and meaningful context and explains why it fits

#### Teacher interpretation
- **Lacking**: the student may still see the topic as something to memorize rather than understand
- **Vague**: the student is beginning to connect the concept with meaning, but only partially
- **Meaningful**: the student shows evidence that the concept has acquired meaningful value beyond rote learning
...
- one value per metric (e.g. descriptive, deep, aligned, meaningful)
